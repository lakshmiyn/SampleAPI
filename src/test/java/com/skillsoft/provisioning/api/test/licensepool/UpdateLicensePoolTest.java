...
@Ignore
public class UpdateLicensePoolTest extends BaseTest {
    private static final SuiteData suiteData = SuiteData.getData();
    private static final Logger log = LoggerFactory.getLogger(UpdateLicensePoolTest.class);
    private static final String PUT_LICENSE_POOLS_PATH = " /v1/license-pools/contract/{oldContract}/line/{oldContractLine}";
    private static final String GET_LICENSE_POOLS_PATH = " /v1/license-pools/contract/{contract}/line/{contractLine}";
    private static final String PATCH_LICENSE_POOLS_BY_KITID_PATH = " /v1/license-pools/kit/{kitId}";
    private static final String PATCH_LICENSE_POOLS_BY_CONTRACT_PATH = " /v1/license-pools/contract/{oldContract}/line/{oldContractLine}";
